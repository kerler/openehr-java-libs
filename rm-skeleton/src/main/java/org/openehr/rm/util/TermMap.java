...
// this class has been copied here from the oet-parser module so the dependency on that module can be removed.
// Removing that dependency allows using rm-skeleton and xml-binding at the same time: using xml-binding and 
// oet-parser at the same time is not possible because they both contain generated xmlbeans classes, and having both
// of those on the classpath at the same time makes it a gamble whether all the xmlbeans schema type system loading 
// will work out ok. Joy.
